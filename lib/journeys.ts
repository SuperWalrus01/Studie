  ...
  goingHome: {
    ...
    destinations: {
      cityVillage: [
        ...
        /** 14 drops on the St Johns side coming home (CS4) */
        {
          stopId: STOPS.stJohnsCS4,
          routes: ["14", "14A"],
          label: "St Johns Church",
        },
      ],
...
/** Opposite side of New Union St after crossing from route 11 / 12X (BY2) */
...
/**
 * To Warwick via the rail station: 9/9B/11/87 from St Johns drop at
 * Rail Station Bridge, and the 12X to campus boards at the same stop.
 */
export const VIA_RAIL_STATION = {
  feederBoards: [
    {
      stopId: STOPS.stJohnsCS2,
      routes: ["9", "9B", "11"],
  ...
  stationStopId: STOPS.railStationOut,
  connectorBoard: {
    stopId: STOPS.railStationOut,
    routes: ["12X"],
