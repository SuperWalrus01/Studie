...
export const STOPS = {
  ...
  /** Rail Station Bridge — same stop serves 9/9B/11/87 drop-off and 12X pickup */
  railStationOut: "43000008201",
  railStationIn: "43000008203",
...
/** @type {readonly ["9", "9B", "11", "12X", "14", "14A", "87"]} */
export const ROUTE_NAMES = ["9", "9B", "11", "12X", "14", "14A", "87"];
